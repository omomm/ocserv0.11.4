...
#可以换成自己的下载地址
        oc_version='1.1.3'
        curl -SOL "https://www.infradead.org/ocserv/download/ocserv-$oc_version.tar.xz"
    } || {
        wget -c https://www.infradead.org/ocserv/download/ocserv-$oc_version.tar.xz
    }
